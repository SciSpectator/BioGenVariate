...
class CompareDistributionsWindow(tk.Toplevel):
    ...
    def _plot_and_analyze(self):
        ...
        self.toolbar_density = NavigationToolbar2Tk(self.canvas_density, self.density_plot_frame); self.toolbar_density.update()
        ...
        self.toolbar_hist = NavigationToolbar2Tk(self.canvas_hist, self.hist_plot_frame); self.toolbar_hist.update()
